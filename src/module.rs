...
pub struct Module {
    ...
    /// Chunk of bytecode generated by the compiler
    chunk: Chunk,

    /// This module's globals, loaded later in the vm
    globals: Vec<Value>,
...
impl Module {
    ...
    pub fn register_global(&mut self, name: String, slot: usize) {
        // The analyzer, which is responsible for calling this function, already ensures that no
